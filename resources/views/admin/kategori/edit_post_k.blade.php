					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input type="text" name="s_video" class="form-control" value="{{ $kategori->sumber_video }}">
							</div>
							<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input type="text" name="s_gambar" class="form-control" value="{{ $kategori->sumber_gambar }}">
							</div>
						</div>
					</div>
